...
class Main 
{
	static function main() 
	{
		...
		var routes = new RouteCollection()
			...
			.addRoute("/q/{questionname}/{answerid}/", { controller : "question", action : "viewanswer" } )
			.addRoute("/q/{questionname}/{answerid}/voteup/", { controller : "question", action : "voteup" } )
			.addRoute("/q/{questionname}/{answerid}/votedown/", { controller : "question", action : "votedown" } )
