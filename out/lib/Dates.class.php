...
class Dates {
	...
	static function snapToWeekDay($time, $day) {
		...
		default:{
			throw new HException(new thx_error_Error("unknown week day '{0}'", null, $day, _hx_anonymous(array("fileName" => "Dates.hx", "lineNumber" => 132, "className" => "Dates", "methodName" => "snapToWeekDay"))));
		}break;
		}
...
function Dates_23(&$period, &$time) {
	throw new HException(new thx_error_Error("unknown period '{0}'", null, $period, _hx_anonymous(array("fileName" => "Dates.hx", "lineNumber" => 107, "className" => "Dates", "methodName" => "snap"))));
}
