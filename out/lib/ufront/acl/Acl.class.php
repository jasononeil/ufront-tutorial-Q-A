...
class ufront_acl_Acl {
	...
	public function addResource($resource, $parent) {
		if(null === $resource) {
			throw new HException(new thx_error_NullArgument("resource", _hx_anonymous(array("fileName" => "Acl.hx", "lineNumber" => 133, "className" => "ufront.acl.Acl", "methodName" => "addResource"))));
		}
		...
		$this->_resources->set($resource, _hx_anonymous(array("resource" => $resource, "parent" => $parent, "children" => new thx_collections_Set())));
		return $this;
	}
	...
	public function inheritsResource($resource, $inherit, $onlyParent) {
		...
		if(null === $resource) {
			throw new HException(new thx_error_NullArgument("resource", _hx_anonymous(array("fileName" => "Acl.hx", "lineNumber" => 158, "className" => "ufront.acl.Acl", "methodName" => "inheritsResource"))));
		}
		if(null === $inherit) {
			throw new HException(new thx_error_NullArgument("inherit", _hx_anonymous(array("fileName" => "Acl.hx", "lineNumber" => 160, "className" => "ufront.acl.Acl", "methodName" => "inheritsResource"))));
		}
	...
	public function removeResource($resource) {
		if(null === $resource) {
			throw new HException(new thx_error_NullArgument("resource", _hx_anonymous(array("fileName" => "Acl.hx", "lineNumber" => 183, "className" => "ufront.acl.Acl", "methodName" => "removeResource"))));
		}
		if(!$this->existsResource($resource)) {
			return false;
		}
	...
	public function _roleDFSAllPrivileges($role, $resource) {
		$dfs = _hx_anonymous(array("visited" => new thx_collections_Set(), "stack" => new _hx_array(array())));
	...
	public function _roleDFSOnePrivilege($role, $resource, $privilege) {
		if(null === $privilege) {
			throw new HException(new thx_error_NullArgument("privilege", _hx_anonymous(array("fileName" => "Acl.hx", "lineNumber" => 427, "className" => "ufront.acl.Acl", "methodName" => "_roleDFSOnePrivilege"))));
		}
		$dfs = _hx_anonymous(array("visited" => new thx_collections_Set(), "stack" => new _hx_array(array())));
	...
	public function _roleDFSVisitOnePrivilege($role, $resource, $privilege, $dfs) {
		if(null === $privilege) {
			throw new HException(new thx_error_NullArgument("privilege", _hx_anonymous(array("fileName" => "Acl.hx", "lineNumber" => 453, "className" => "ufront.acl.Acl", "methodName" => "_roleDFSVisitOnePrivilege"))));
		}
