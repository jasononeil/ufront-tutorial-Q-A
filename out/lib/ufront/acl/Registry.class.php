...
class ufront_acl_Registry {
	...
	public function add($role, $parent, $parents) {
		...
		$roleParents = new thx_collections_Set();
		{
			$_g = 0;
		...
		$this->_roles->set($role, _hx_anonymous(array("role" => $role, "parents" => $roleParents, "children" => new thx_collections_Set())));
	}
	...
	public function inherits($role, $inherit, $onlyParents) {
		...
		if(null === $role) {
			throw new HException(new thx_error_NullArgument("role", _hx_anonymous(array("fileName" => "Registry.hx", "lineNumber" => 60, "className" => "ufront.acl.Registry", "methodName" => "inherits"))));
		}
		if(null === $inherit) {
			throw new HException(new thx_error_NullArgument("inherit", _hx_anonymous(array("fileName" => "Registry.hx", "lineNumber" => 62, "className" => "ufront.acl.Registry", "methodName" => "inherits"))));
		}
