...
class ufront_web_HttpApplication {
	...
	public function _dispatchError($e) {
		...
		$event = _hx_anonymous(array("application" => $this, "error" => ((Std::is($e, _hx_qtype("thx.error.Error"))) ? $e : new thx_error_Error(Std::string($e), null, null, _hx_anonymous(array("fileName" => "HttpApplication.hx", "lineNumber" => 305, "className" => "ufront.web.HttpApplication", "methodName" => "_dispatchError"))))));
