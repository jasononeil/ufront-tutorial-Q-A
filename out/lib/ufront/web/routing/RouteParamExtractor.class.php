...
class ufront_web_routing_RouteParamExtractor {
	public function __construct($ast) {
		...
		if(null === $ast) {
			throw new HException(new thx_error_NullArgument("ast", _hx_anonymous(array("fileName" => "RouteParamExtractor.hx", "lineNumber" => 18, "className" => "ufront.web.routing.RouteParamExtractor", "methodName" => "new"))));
		}
		$this->ast = $ast;
	}}
	public $ast;
	...
	public function extract($uri) {
		if(null === $uri) {
			throw new HException(new thx_error_NullArgument("uri", _hx_anonymous(array("fileName" => "RouteParamExtractor.hx", "lineNumber" => 24, "className" => "ufront.web.routing.RouteParamExtractor", "methodName" => "extract"))));
		}
