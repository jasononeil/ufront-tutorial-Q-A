...
class ufront_web_routing_RouteUriParser {
	...
	public function parse($uri, $implicitOptionals) {
		if(null === $uri) {
			throw new HException(new thx_error_NullArgument("uri", _hx_anonymous(array("fileName" => "RouteUriParser.hx", "lineNumber" => 17, "className" => "ufront.web.routing.RouteUriParser", "methodName" => "parse"))));
		}
		...
		$this->restUsed = false;
		$capturedParams = new thx_collections_Set();
