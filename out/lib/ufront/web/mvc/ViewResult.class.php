...
class ufront_web_mvc_ViewResult extends ufront_web_mvc_ActionResult {
	...
	public function executeResult($context) {
		if(null === $context) {
			throw new HException(new thx_error_NullArgument("context", _hx_anonymous(array("fileName" => "ViewResult.hx", "lineNumber" => 31, "className" => "ufront.web.mvc.ViewResult", "methodName" => "executeResult"))));
		}
	...
	public function findView($context, $viewName) {
		if(null === $viewName) {
			throw new HException(new thx_error_NullArgument("viewName", _hx_anonymous(array("fileName" => "ViewResult.hx", "lineNumber" => 63, "className" => "ufront.web.mvc.ViewResult", "methodName" => "findView"))));
		}
