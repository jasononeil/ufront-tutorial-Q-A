...
ufront_web_mvc_ModelBinderDictionary::$__meta__ = _hx_anonymous(array("fields" => _hx_anonymous(array("count" => _hx_anonymous(array("get" => new _hx_array(array("getCount")))), "defaultBinder" => _hx_anonymous(array("set" => new _hx_array(array("setDefaultBinder")), "get" => new _hx_array(array("getDefaultBinder")))), "keys" => _hx_anonymous(array("get" => new _hx_array(array("getKeys")))), "values" => _hx_anonymous(array("get" => new _hx_array(array("getValues"))))))));
