...
class ufront_web_mvc_DefaultControllerFactory implements ufront_web_mvc_IControllerFactory{
	public function __construct($controllerBuilder, $dependencyResolver) {
		...
		if(null === $controllerBuilder) {
			throw new HException(new thx_error_NullArgument("controllerBuilder", _hx_anonymous(array("fileName" => "DefaultControllerFactory.hx", "lineNumber" => 16, "className" => "ufront.web.mvc.DefaultControllerFactory", "methodName" => "new"))));
		}
