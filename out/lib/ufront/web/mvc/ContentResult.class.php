...
class ufront_web_mvc_ContentResult extends ufront_web_mvc_ActionResult {
	...
	public function executeResult($controllerContext) {
		if(null === $controllerContext) {
			throw new HException(new thx_error_NullArgument("controllerContext", _hx_anonymous(array("fileName" => "ContentResult.hx", "lineNumber" => 19, "className" => "ufront.web.mvc.ContentResult", "methodName" => "executeResult"))));
		}
