...
class thx_collections_CascadeHash {
	public function __construct($hashes) {
		if(!php_Boot::$skip_constructor) {
		if(null === $hashes) {
			throw new HException(new thx_error_NullArgument("hashes", _hx_anonymous(array("fileName" => "CascadeHash.hx", "lineNumber" => 16, "className" => "thx.collections.CascadeHash", "methodName" => "new"))));
		}
		$this->_h = new HList();
		{
			$_g = 0;
